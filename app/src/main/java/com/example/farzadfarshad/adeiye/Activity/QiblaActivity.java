...
import com.example.farzadfarshad.adeiye.logic.QiblaCompassManager;
import com.example.farzadfarshad.adeiye.util.ConcurrencyUtil;
import com.example.farzadfarshad.adeiye.util.ConstantUtilInterface;
import com.example.farzadfarshad.adeiye.util.LocationEnum;
...
public class QiblaActivity extends Activity implements AnimationListener,
    ...
    public boolean checkCourseLocationPermission() {
        if (ContextCompat.checkSelfPermission(this,
